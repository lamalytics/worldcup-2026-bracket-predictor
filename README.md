...
- **Share your bracket** — a **share link** that encodes the whole bracket in the URL (open it and you see the exact picks), a downloadable **interactive HTML** bracket, and a copy-paste text summary.
...
Every bracket is encoded into a short code (12 group picks + 31 knockout results) carried in the URL as `?b=...`. Copy the share link from the My Prediction page — or straight from your browser's address bar — and whoever opens it lands on your exact bracket. You can also download the bracket as a standalone interactive HTML file.
